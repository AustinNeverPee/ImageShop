 ...
 * 自定义复数类
 * 实现复数的加减乘除等运算
 * 大部分代码实现由“cyning4星运”博主（CSDN博客）提供，在此表示感谢
 */
...
public class Complex {
	...
	/**
	 * return a new Complex object whose value is (this - b) 减法
	 * 
	 * @param b
	 * @return
	 */
	...
	/**
	 * return a new Complex object whose value is (this * b) 乘以一个复数
	 * 
	 * @param b
	 *            被乘的复数
	 * @return
	...
	/**
	 * return a new Complex object whose value is the reciprocal of this</br> 倒数
	 * a +bi 的倒数 </br> a -bi</br> —————————————</br> a^2 + b ^2</br>
	 */
